package com.easy.common.datasource.dao;
...
import com.easy.common.datasource.utils.ProviderUtils;
...
public class BaseProvider<T> {
     ...
     * 组装前缀表名字
     *
     * @return String TABLE_PREFIX+TableName
     */
    ...
    public Map<String, String> getFieldMap() {
        ...
        for (Field field : allField) {
            ...
            if (Objects.nonNull(tableField)) {
                ...
                columnName = StringUtils.toUnderlineCase(name);
            }
    ...
    public List<String> getColumnList() {
        ...
        for (Field field : allField) {
            ...
            if (Objects.nonNull(tableField)) {
                ...
                columnName = StringUtils.toUnderlineCase(field.getName());
            }
